...
public class AbenkGDPR {
    ...
    private static String preferences_name = "uc.benkkstudio.abenkgdprlibrary";
    ...
    public AbenkGDPR abenkGDPR;

    // Admob banner test id
    public static String DUMMY_ADMOB = "pub-3940256099942544";
    public static String DUMMY_BANNER = "ca-app-pub-3940256099942544/6300978111";
    public static String DUMMY_INTERSTITIAL = "ca-app-pub-3940256099942544/1033173712";
    ...
    public static class Builder {
        ...
        // Build
        public AbenkGDPR build() {
            if(this.DEBUG) {
                AbenkGDPR abenkGDPR = new AbenkGDPR(context, publisherId, privacyURL, true);
                abenkGDPR.LOG_TAG = this.LOG_TAG;
                abenkGDPR.DEVICE_ID = this.DEVICE_ID;
                return abenkGDPR;
            } else {
                return new AbenkGDPR(context, publisherId, privacyURL);
            }
        }
    }

    // Initialize debug
    public AbenkGDPR(Context context, String publisherId, String privacyURL, boolean DEBUG) {
        this.context = context;
    ...
    public AbenkGDPR(Context context, String publisherId, String privacyURL) {
        this.context = context;
        ...
        form = new ConsentForm.Builder(context, privacyUrl)
                .withListener(new ConsentFormListener() {
                    ...
                    public void onConsentFormError(String reason) {
                        ...
                        // Callback on Error
                        if (callback != null) {
                            abenkGDPR.isRequestLocationIsEeaOrUnknown(new LocationIsEeaOrUnknownCallback() {
                                @Override
